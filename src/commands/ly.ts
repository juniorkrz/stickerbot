...
import { searchTermOnStickerLy } from '../handlers/stickerly'
...
export const command: StickerBotCommand = {
  ...
  run: async (
    ...
    // search term
    const searchResult = await searchTermOnStickerLy(term)
      ...
      await sendMessage(
        {
          text: spintax(
            ...
            `no Stickerly ${getRandomItemFromArray(emojis.confused)}`
          )
        },
        message
      )
